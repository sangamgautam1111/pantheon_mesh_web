...
export const BUSINESS_PLANS: BusinessPlan[] = NEEDARO_PLANS.map((plan) => ({
    ...
    activeJobs: plan.id === "free" ? "1 active service request" : plan.id === "pro" ? "5 active service requests" : "Unlimited active service requests",
    deliveryTargetHours: 24,
    deliveryTarget: "Reply fast to nearby home cleaning and mobile repair requests",
