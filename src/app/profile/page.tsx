    ...
    const submitBusinessVerification = async () => {
        ...
        try {
            ...
            const result = await requestBusinessVerification({
                ...
                shopFrontPhoto: businessVerifyForm.businessFrontPhoto,
                insideShopPhoto: businessVerifyForm.businessInsidePhoto,
            ...
            await updateUserProfile({
                ...
                shopFrontPhotoUrl: businessVerifyForm.businessFrontPhoto,
                shopInsidePhotoUrl: businessVerifyForm.businessInsidePhoto,
